                    ...
                    <div class="card mb-4">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <p class="text-sm mb-0 text-capitalize font-weight-bold">จำนวนผู้เข้าใช้งาน</p>
                ...
                <div class="col-lg-6">
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            <h6>สาขาที่สร้างportfoloมากที่สุด</h6>
                        </div>
                                            ...
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    ...
                                                    <div class="d-flex flex-column justify-content-center">
                                                        ...
                                                        <p class="text-xs text-secondary mb-0">วิศวกรรมโยธา</p>
                                                    </div>
                                                </div>
                                            </td>
                ...
                <div class="card-body p-3">
                    <div class="bg-gradient-dark border-radius-lg py-3 pe-1 mb-3">
                        <div class="chart">
                            ...
                            <canvas id="chart-bars" class="chart-canvas chartjs-render-monitor" height="170" style="display: block; height: 170px; width: 702px;" width="702"></canvas>
                        </div>
                    </div>
