    <nav class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start position-absolute ms-3 bg-white" id="sidenav-main">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="index.php">
                ...
                <span class="ms-1 font-weight-bold">engineer portfoilo</span>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <!-- หลักสูตรที่เปิดสอน -->
                <li class="nav-item">
                    <a class="nav-link "  href="https://engineer.wu.ac.th/?page_id=15080" target="_blank">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <span class="nav-link-text ms-1">หลักสูตรที่เปิดสอน</span>
                    </a>
                </li>
                <!-- บุคลากร -->
                <li class="nav-item">
                    <a class="nav-link  "  href="https://engineer.wu.ac.th/?page_id=6767" target="_blank">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g id="Rounded-Icons" transform="translate(-1869.000000, -293.000000)" fill="#FFFFFF" fill-rule="nonzero">
                ...
                <li class="nav-item">
                    <a class="nav-link  " href="contact.php">
                        ...
                        <span class="nav-link-text ms-1">ติดต่อ</span>
                    </a>
                </li>
                <!-- Sign In -->
                <li class="nav-item">
                    <a class="nav-link  " href="../portfolio/index.php">
                        ...
                        <span class="nav-link-text ms-1">Sign In | Sign Up</span>
                    </a>
                </li>
                <!-- Sign Up -->
                <!-- <li class="nav-item">
                    <a class="nav-link  " href="../portfolio/register.php">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
